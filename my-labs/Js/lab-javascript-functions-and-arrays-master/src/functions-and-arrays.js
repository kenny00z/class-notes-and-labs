...
// })
//  otra manera de hacer el loop en el ejercicio anterior // 
...
function sum(arraySum) {
  ...
  arraySum.forEach(element => {
    ...
    if (typeof element === "string") {
      ...
      result += element;
    } else if (typeof element === "string" || typeof element === "number" || typeof element === "boolean" === true) {
      result += element;
    } else if 
      (typeof element === "array" || typeof element === "object") {
...
// FUNCION DEL EJERCICIO function averageNumbers() {}



// DMix of diego stylah and mine.
function averageNumbers(numbersAvg) {
  if (sumNumbers(numbersAvg) / numbersAvg.length) {
...
function averageWordLength(wordsArr) { 
  ...
  oneElement = wordsArr.join('');
  result = oneElement.length / arrayLength;
  return result;
}
...
// INTENTO DE FOR EACH SIN BUEN RESULTADO ----- REVISAR  Y INTENTAR QUE FUNCIONE -----
...
//   console.log(result / mixedArr.length);
  
//   return result / mixedArr.length;
  
// };

// RESUELTO CON FOR NORMAL
function avg(mixedArr) {
  if (!mixedArr.length) return null;
...
function doesWordExist(wordsFind, element) {
  ...
  return wordsFind.includes(element);  
}/// PREGUNTAR TAMBIEN PARA ACABAR DE ENTENDERLO SOBRE TODO EL TEMA ARGUMENTOS //////////////////////
...
//   if (element === wordsCount[i]) {
//     counter++;
//     }
// }  NO ME CONSEGUIA EL MISMO RESULTADO PREGUNTAR ///
