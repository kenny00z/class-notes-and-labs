...
const newDiv = document.createElement("div"); // PARA CREAR DIV
const newP = document.createElement("p"); // PARA CREAR P

newDiv.setAttribute("id", "insert-p"); // PARA DAR ATRIBUTO EN ESTE CASO ID Y SU NOMBRE

document.querySelector("body").appendChild(newDiv); // PARA INSERTAR EL DIV EN EL BODY
document.querySelector("#insert-p").appendChild(newP); // PARA INSERTAR LA P DENTRO DEL DIV A TRAVES DE SU #ID
